...
export default function AppShell({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="flex flex-col md:flex-row h-screen w-screen overflow-hidden bg-[#f8f7fc] text-[#10224f]">
      {/* Rome Bois Sidebar */}
      <Sidebar userRole={session?.role} username={session?.username} />

      {/* Main Content Area */}
      <div className="flex-1 flex flex-col min-w-0 h-full overflow-hidden">
        <main className="flex-1 overflow-y-auto p-2 sm:p-4 md:p-6 bg-[#f8f7fc]">
